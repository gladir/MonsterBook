...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette  fonction permet  de connaŒtre  le nombre de plage  de m‚moire EMS
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette proc‚dure libŠre tout la m‚moire utilis‚ par le programme et permet
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette fonction libŠre de la variable de param‚trage  ®SizeP¯ de la m‚moire
 par multiple de 16 octets pour permettre ‚ventuellement … d'autre programme
 d'ˆtre charger dans cette mˆme m‚moire.
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette proc‚dure libŠre le maximum de m‚moire sans perte de donn‚e dans le
 tas pour permettre  … d'autre application  d'ˆtre charg‚e  dans la m‚moire
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 garder  pour  l'application  actuel  pour des traŒtements  possiblement en
 arriŠre plan...
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette proc‚dure libŠre la m‚moire conventionnel  (en mode r‚el) r‚serv‚
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍ
  ...
  Q         Nom de l'objet de recouvrement de tampon (Array List)
  P         Position devant ˆtre atteint dans la liste
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍ
  ...
  Q         Nom de l'objet de recouvrement de tampon (Array List)
  PChr      Pointeur de la chaŒne de caractŠres de format  ®ASCIIZ¯  devant
            ˆtre ajouter au recouvrement de tampon (Array List)
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍ
  ...
  Q         Nom de l'objet de recouvrement de tampon (Array List)
  PChr      Pointeur de la chaŒne de caractŠres de format  ®ASCIIZ¯ devant
            ˆtre ajouter au recouvrement de tampon (Removable Buffer)
  Num       Nombre entier devant ˆtre ajouter … la  liste avant le contenu
            de l'enregistrement.
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette fonction permet d'ajouter une ligne de format chaŒne de caractŠres
 ...
 ÍÍÍÍÍÍÍÍÍÍ
  ...
  Q         Nom de l'objet de recouvrement de tampon (Array List)
  Str       Pointeur de la chaŒne de  caractŠres de  format  Pascal devant
            ˆtre ajouter au recouvrement de tampon (Array List)
  Num       Nombre entier devant ˆtre ajouter … la  liste avant le contenu
            de l'enregistrement.
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍ
  ...
  Q         Nom de l'objet de recouvrement de tampon (Array List)
  S         Nombre d'espace  avant  la  chaŒne  de caractŠres  devant ˆtre
            rajouter.
  Str       Pointeur de la chaŒne de  caractŠres de  format  Pascal devant
            ˆtre ajouter au recouvrement de tampon (Array List)
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 une ligne de format chaŒne de caractŠres Pascal … la liste sym‚trique de
 l'objet ®ArrayList¯.
 ...
 ÍÍÍÍÍÍÍÍÍÍ
  ...
  Str       Pointeur de la chaŒne de  caractŠres de  format  Pascal devant
            ˆtre ajouter au recouvrement de tampon (Array List)
  P         Position dans la liste  … laquel  il faut ajouter la chaŒne de
            caractŠres de format Pascal.
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette fonction permet d'ajouter, … une position pr‚cise dans la liste,
 une ligne de format chaŒne  de caractŠres Pascal avec un mot … la liste
 sym‚trique de l'objet ®ArrayList¯.
 ...
 ÍÍÍÍÍÍÍÍÍÍ
  ...
  Q         Nom de l'objet de recouvrement de tampon (Array List)
  P         Position dans la liste  … laquel  il faut ajouter la chaŒne de
            caractŠres de format Pascal et le mot.
  Str       Pointeur de la chaŒne de  caractŠres de  format  Pascal devant
            ˆtre ajouter au recouvrement de tampon (Array List)
  Num       Nombre devant … ajouter  (avec la chaŒnes de caractŠres)  dans
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette fonction permet de connaŒtre le contenu d'une ligne … une position
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette fonction permet de connaŒtre le contenu d'une ligne de format
 chaŒne  de caractŠres  Pascal …  une position pr‚cis  dans une liste
 sym‚trique de l'objet ®ArrayList¯.
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette fonction permet de connaŒtre le contenu de la ligne … la position
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 l'objet ®ArrayList¯ et de connaŒtre la longueur de la ligne effacer.
}
...
{ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÜ
 ...
 ÍÍÍÍÍÍÍÍÍÍÍ
  ...
  Cette proc‚dure libŠre la m‚moire (tout comme sa soeur FreeMem) mais en
 plus r‚initialise les variables d'appel:  Le tampon pointe sur NIL et la
 variable de taille ®Size¯, vaut 0 aprŠs appel de cette proc‚dure.
}
